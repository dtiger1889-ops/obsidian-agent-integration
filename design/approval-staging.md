...
agent_note: "One plain line: what it is, why this destination, what I need from you."
...
```
python ./extract_approvals.py --vault <vault-path>
```
...
The cross-platform script is in this repo: [extract_approvals.py](../operations/extract_approvals.py).
A PowerShell equivalent is also included for Windows-only setups:
[extract_approvals.ps1](../operations/extract_approvals.ps1).
